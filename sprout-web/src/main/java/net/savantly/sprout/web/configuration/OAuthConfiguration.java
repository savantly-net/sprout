...
import net.savantly.sprout.security.oauth.ClientResources;
import net.savantly.sprout.security.oauth.GithubPrincipalExtractor;
import net.savantly.sprout.security.oauth.LinkedinPrincipalExtractor;
